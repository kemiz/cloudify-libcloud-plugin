...
class HPCloudLibcloudServerClient(LibcloudServerClient):
...
class HPCloudLibcloudFloatingIPClient(LibcloudFloatingIPClient):
...
class HPCloudLibcloudSecurityGroupClient(LibcloudSecurityGroupClient):
...
class HPCloudLibcloudProviderContext(LibcloudProviderContext):
